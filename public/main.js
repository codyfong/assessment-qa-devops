...
const drawFive = () => {
    axios.get('http://107.20.43.234/api/robots/five')
        .then(res => {
...
const duel = () => {
    ...
    setTimeout(() => {
        axios.post('http://107.20.43.234/api/duel', {compDuo, playerDuo})
            .then(({data}) => {
...
const getPlayerStats = () => {
    axios.get('http://107.20.43.234/api/player')
...
const getAllBots = () => {
    axios.get('http://107.20.43.234/api/robots')
        .then(({data}) => {
